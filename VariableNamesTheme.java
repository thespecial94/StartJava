public class VariableNamesTheme {
    public static void main(String[] args) {
        ...
        String startDate = "в 13:00 по Московскому времени";
        // окончание диапазона
        ...
        System.out.println("(что-либо) активный? " + active);
